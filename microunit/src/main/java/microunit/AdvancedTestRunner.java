...
public class AdvancedTestRunner extends TestRunner{
    ...
    protected void invokeTestMethod(Method testMethod, Object instance, Result result) throws IllegalAccessException {
        ...
        try {
            ...
            if(testAnnotation.expected() != Test.None.class){
                throw new InvocationTargetException( new AssertionError(testAnnotation.expected() + "is not thrown"));
            }
            result.onSuccess();
            ...
            if (cause instanceof AssertionError){
                ...
                if(cause.getClass() == testAnnotation.expected()){
                    result.onSuccess();
                }else{
                    result.onError();
                }
