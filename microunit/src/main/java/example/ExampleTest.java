...
public class ExampleTest {
    ...
    @Test
    public void b(){
        Assert.assertTrue(1+1 == 0, "This should always be false");
    }
    @Test
    public void c(){
    ...
    public  void e() throws Exception{
        throw new IOException("kuttykurutty");
    }
    @Test(expected = IOException.class)
    ...
    public static void main(String[] args) {
        new TestRunner(ExampleTest.class) {
            @Override
            protected void invokeTestMethod(Method testMethod, Object instance, Result result) {
